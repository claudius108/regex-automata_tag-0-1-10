## Note: This is a copy of tag 0.1.10 of the [regex-automata crate](https://github.com/BurntSushi/regex-automata), needed for a static search engine to be used in browser [https://gitlab.com/claudius-teodorescu/index-search-engine](https://gitlab.com/claudius-teodorescu/index-search-engine). The only change I made is in ```Cargo.toml``` file, where I changed the ```fst``` dependency to be [https://github.com/claudius108/fst.git](https://github.com/claudius108/fst.git). Everything else is left as [Andrew Gallant](https://github.com/BurntSushi) made it.
